...
func main(){
	...
	fmt.Println("O tipo da variável versão é", reflect.TypeOf(versao)) //o pacote reflect juntamente com a funcão TypeOf() permite descobrir o tipo de determinada variável
}